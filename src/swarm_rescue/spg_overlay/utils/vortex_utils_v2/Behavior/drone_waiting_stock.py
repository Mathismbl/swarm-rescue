...
logger = logging.getLogger("drone_waiting_stock behavior")
...
class DroneWaitingInStock(VortexModule):
    def __init__(self,
                 signature,
                 identifier
                 ):
        ...
        self.services_client = {"stationary":[]} # tâche que le module peut demander à un autre module        
