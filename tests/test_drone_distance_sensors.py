...
class TestComputeRayAngles:
    ...
    #  Tests that the function returns the correct array of ray angles for
    #  a given field of view and number of rays
    ...
    #  Tests that the function returns the correct array of ray angles for a
    #  different field of view and number of rays
    ...
    #  Tests that the function returns the correct array of ray angles when
    #  the number of rays is 1
    ...
    #  Tests that the function returns the correct array of ray angles when
    #  the number of rays is very large
    ...
    #  Tests that the function raises a ValueError when fov_rad is not a
    #  positive float
